...
class ProjectOwnerContainer extends Component {
	constructor (props) {
      ...
      mvps: [{'id': '5', 'title': 'test', 'description': 'testing this', 'videoLink': 'someurl.com', 'repoLink': 'somerepo'}, {'title': 'testy test', 'description': 'testing this as well', 'videoLink': 'someurl.com2', 'repoLink': 'somerepo2'}]
		}
	...
	awardMVP (e) {
		...
		.then((err, results) => {
			...
			console.log(MVP updated as won)
			...
			.then((err, restuls) => {
				...
				console.log(Project was updated as awarded);
